...
SET Montreal_CONF=".\MS12-hCMA_CSD\configuration.yaml"
SET Toronto_CONF=".\TS12-hCMA_CSD\configuration.yaml"
SET Vancouver_CONF=".\VS12-hCMA_CSD\configuration.yaml"
