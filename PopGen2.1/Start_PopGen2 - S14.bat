...
SET Montreal_CONF=".\MS14-hCMA_ADA\configuration.yaml"
SET Toronto_CONF=".\TS14-hCMA_ADA\configuration.yaml"
SET Vancouver_CONF=".\VS14-hCMA_ADA\configuration.yaml"
